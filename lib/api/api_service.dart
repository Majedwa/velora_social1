...
class ApiService {
  ...
  final String baseUrl = 'http://172.30.80.58:5000/api';
  ...
  // Modificación en lib/api/api_service.dart

// Obtener URL completa para una imagen - versión mejorada
String getFullImageUrl(String imagePath) {
  // Si está vacío o es la imagen por defecto, devolver la URL de la imagen por defecto
  ...
  // Extraer base de URL de API
  // Asegurarse de quitar '/api' si está presente en la URL base
  ...
  if (imagePath.startsWith('/')) {
    fullUrl = baseUrlWithoutApi + imagePath;
  } else {
    fullUrl = baseUrlWithoutApi + '/' + imagePath;
  }
